...
class PaymentState extends State<Payment> {
  ...
  Widget build(BuildContext context) {
    ...
    final vp = Provider.of<ProductViewModel>(context);
    return Scaffold(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          Fluttertoast.showToast(msg: "Ödemeniz Alındı ! ");
                          await vm.addOrder(vu.currentUser!, vp.shoppingcard,
                              vp.totalAmount.toDouble());
                        },
                      ),
                    ],
                  ),
